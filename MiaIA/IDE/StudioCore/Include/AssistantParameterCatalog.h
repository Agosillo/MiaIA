    ...
    inline const std::vector<AssistantParameterDefinition>& AssistantParameters()
    {
        static const auto parameters = []
        {
            ...
            std::vector<AssistantParameterDefinition> result{
                ...
                {"miaia_network_create", "hidden_width", T::PositiveInteger, {"hidden_width", "hidden width", "neurons per layer", "neurons per hidden layer", "neuron per layer", "neuron per hidden layer", "neurons in each layer", "neurons in each hidden layer", "neuroni per layer", "neuroni per hidden layer", "neuroni per livello", "neuroni per livello nascosto", "neuroni per strato", "neuroni per strato nascosto", "neuroni per ogni livello", "neuroni per ogni livello nascosto", "neuroni per ogni strato", "neuroni per ogni strato nascosto"}, {}},
