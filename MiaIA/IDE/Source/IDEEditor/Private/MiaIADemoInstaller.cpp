...
namespace
{
    ...
    UBlueprint* LoadOrCreateDemoBlueprintInternal()
    {
    ...
    void InstallDemoInCurrentMapInternal(UBlueprint& blueprint)
    {
...
UBlueprint* FMiaIADemoInstaller::LoadOrCreateBlueprint()
{
    return LoadOrCreateDemoBlueprintInternal();
}

void FMiaIADemoInstaller::InstallInCurrentMap(UBlueprint& Blueprint)
{
    InstallDemoInCurrentMapInternal(Blueprint);
}
